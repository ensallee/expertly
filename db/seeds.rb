...
us2 = UserSkill.create(user: u3, skill: s2, description: "Learn Ruby on Rails, build an app like this exact website here.")
us3 = UserSkill.create(user: u4, skill: s3, description: "Learn how to make nasty beats - very sick")
us4 = UserSkill.create(user: u3, skill: s4, description: "Write some functions and vars and lots of semi-colons as many semi-colons as you can dream up bc you'll need all of them")
us5 = UserSkill.create(user: u1, skill: s9, description: "Knit a scarf and other things!")
us6 = UserSkill.create(user: u3, skill: s8, description: "Get your finances in order!")
us7 = UserSkill.create(user: u4, skill: s2, description: "Were gonna go off the rails, on Rails!")
us8 = UserSkill.create(user: u4, skill: s12, description: "Cells and stuff....")
us9 = UserSkill.create(user: u1, skill: s14, description: "Hola! Learn how to speak Spanish with me!")
